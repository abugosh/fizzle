(ns fizzle.cards.gemstone-mine-test
...
(deftest gemstone-mine-card-definition-test
  ...
  (testing "ETB effects add 3 mining counters"
    (let [etb-effects (:card/etb-effects cards/gemstone-mine)]
  ...
  (testing "Mana ability structure"
    (let [abilities (:card/abilities cards/gemstone-mine)]
  ...
  (testing "Sacrifice condition on ability"
    (let [ability (first (:card/abilities cards/gemstone-mine))

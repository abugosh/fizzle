...
return (""+cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__22182 = cljs.core.instance_QMARK_;
var expr__22183 = reactive_val;
if(cljs.core.truth_((pred__22182.cljs$core$IFn$_invoke$arity$2 ? pred__22182.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__22183) : pred__22182.call(null,reagent.ratom.RAtom,expr__22183)))){
return "ra";
} else {
if(cljs.core.truth_((pred__22182.cljs$core$IFn$_invoke$arity$2 ? pred__22182.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__22183) : pred__22182.call(null,reagent.ratom.RCursor,expr__22183)))){
return "rc";
} else {
if(cljs.core.truth_((pred__22182.cljs$core$IFn$_invoke$arity$2 ? pred__22182.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__22183) : pred__22182.call(null,reagent.ratom.Reaction,expr__22183)))){
return "rx";
} else {
if(cljs.core.truth_((pred__22182.cljs$core$IFn$_invoke$arity$2 ? pred__22182.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__22183) : pred__22182.call(null,reagent.ratom.Track,expr__22183)))){
return "tr";
} else {
return "other";
}

...
var i_14473 = (self__.level + (1));
while(true){
if((i_14473 <= (new_level + (1)))){
(update[i_14473] = self__.header);

var G__14476 = (i_14473 + (1));
i_14473 = G__14476;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_14477 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14477[i]));
} else {
x__$2.forward.push((((i < links_14477.length))?(links_14477[i]):null));
}

if((i < links_14477.length)){
(links_14477[i] = x__$2);
} else {
links_14477.push(x__$2);
}
...
var links_14491 = (update[i_14490]).forward;
if((x__$1 === (((i_14490 < links_14491.length))?(links_14491[i_14490]):null))){
(links_14491[i_14490] = (x__$1.forward[i_14490]));

var G__14492 = (i_14490 + (1));
i_14490 = G__14492;
continue;
} else {
var G__14493 = (i_14490 + (1));
i_14490 = G__14493;
continue;
}
} else {
